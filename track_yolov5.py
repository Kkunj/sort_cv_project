...
import os
if not os.path.exists('output_frames_petso9'):
    os.makedirs('output_frames_petso9')
...
for img_file in sorted(Path(images_folder_path).glob('*.jpg')):
    ...
    output_filename = f'output_frames_petso9/frame_{frame_count}.jpg'
